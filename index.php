                ...
                <svg id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
                  <g id="XMLID_1402_">
                    <g id="XMLID_387_">
                      ...
                      <path id="XMLID_492_" d="m10 332c2.63 0 5.21-1.07 7.07-2.93s2.93-4.44 2.93-7.07-1.07-5.21-2.93-7.07-4.44-2.93-7.07-2.93-5.21 1.07-7.07 2.93-2.93 4.44-2.93 7.07 1.07 5.21 2.93 7.07 4.44 2.93 7.07 2.93z" />
                    </g>
                  </g>
                </svg>
              </div>
      ...
      <div class="row">
        <div class="col">
          <form method="post" action="immagine.php">
            ...
            <div class="form-row ">
                <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                    <input class="custom-control-input" type="checkbox" id="tissue" name="tissue" value="1">
                    <label class="custom-control-label" for="tissue">Tissue Punch</label>
                </div>
                <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                    <input class="custom-control-input" type="checkbox" id="bone" name="bone" value="1">
                    <label class="custom-control-label" for="bone">Bone Flattener</label>
                </div>
                <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                    <input class="custom-control-input" type="checkbox" id="start" name="start" value="1">
              ...
              <div class="form-row ">
                  ...
                  <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                      <input class="custom-control-input" type="checkbox" id="pilot10" name="pilot" value="10">
                      <label class="custom-control-label" for="pilot10">Pilot 10</label>
                  </div>
              </div>
                  <div class="form-row ">
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="pilot12" name="pilot" value="12">
                          <label class="custom-control-label" for="pilot12">Pilot 12</label>
                      </div>
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="pilot14" name="pilot" value="14">
                          <label class="custom-control-label" for="pilot14">Pilot 14</label>
                      </div>
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" name="pilot" value="16">
              ...
              <fieldset style="border: 1px solid dodgerblue; padding-bottom: 25px">
                  ...
                  <div class="form-row ">
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-2906" name="tip" value="06">
                          <label class="custom-control-label" for="gttd-2906">GTTD-2906</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-2908" name="tip" value="08">
                          <label class="custom-control-label" for="gttd-2908">GTTD-2908</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-2910" name="tip" value="10">
                          <label class="custom-control-label" for="gttd-2910">GTTD-2910</label>
                      </div>
                  </div>
                  <div class="form-row ">
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3206" name="tip" value="06">
                          <label class="custom-control-label" for="gttd-3206">GTTD-3206</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3208" name="tip" value="08">
                          <label class="custom-control-label" for="gttd-3208">GTTD-3208</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3210" name="tip" value="10">
                          <label class="custom-control-label" for="gttd-3210">GTTD-3210</label>
                      </div>
                  </div>
                  <div class="form-row ">
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3506" name="tip" value="06">
                          <label class="custom-control-label" for="gttd-3506">GTTD-3506</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3508" name="tip" value="08">
                          <label class="custom-control-label" for="gttd-3508">GTTD-3508</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3510" name="tip" value="10">
                          <label class="custom-control-label" for="gttd-3510">GTTD-3510</label>
                      </div>
                  </div>
                  <div class="form-row ">
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3806" name="tip" value="06">
                          <label class="custom-control-label" for="gttd-3806">GTTD-3806</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3808" name="tip" value="08">
                          <label class="custom-control-label" for="gttd-3808">GTTD-3808</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-3810" name="tip" value="10">
                          <label class="custom-control-label" for="gttd-3810">GTTD-3810</label>
                      </div>
                  </div>
                  <div class="form-row ">
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-4006" name="tip" value="06">
                          <label class="custom-control-label" for="gttd-4006">GTTD-4006</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-4008" name="tip" value="08">
                          <label class="custom-control-label" for="gttd-4008">GTTD-4008</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-4010" name="tip" value="10">
                          <label class="custom-control-label" for="gttd-4010">GTTD-4010</label>
                      </div>
                  </div>
                  <div class="form-row ">
                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-4506" name="tip" value="06">
                          <label class="custom-control-label" for="gttd-4506">GTTD-4506</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-4508" name="tip" value="08">
                          <label class="custom-control-label" for="gttd-4508">GTTD-4508</label>
                      </div>

                      <div class="col-lg-4 custom-control-inline custom-checkbox" style="justify-content: center; margin-right: 0">
                          <input class="custom-control-input" type="checkbox" id="gttd-4510" name="tip" value="10">
